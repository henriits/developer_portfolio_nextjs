    ...
    <section id="experience" className="w-full text-center px-6 py-12">
        ...
        <div className="overflow-hidden">
            <Slide delay={0.3}>
                ...
                <p>
                    Completed an intensive program focused on front-end and
                    back-end development, learning modern technologies like
        ...
        <div className="overflow-hidden">
            <Slide delay={0.3}>
                ...
                <p>
                    Gained expertise in building responsive and user-friendly
